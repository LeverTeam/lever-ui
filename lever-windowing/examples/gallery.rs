...
use lever_core::widgets::{
    ...
    Checkbox, ConstraintLayout, Dropdown, Flex, Grid, Label, Scroll, Spacer, ThemeToggle, Toggle,
    PARENT,
};
...
impl App for GalleryApp {
    ...
    fn view(&self) -> Box<dyn Widget<Self::Message>> {
                ...
                BoxWidget::new(theme.surface)
                    ...
                    .with_child(Box::new(
                        Flex::column(vec![
                            Box::new(
                                Flex::column(vec![
                                    Box::new(Label::new(title, 24.0, theme.text)),
                                    Box::new(Spacer::new().with_size(10.0, 6.0)),
                                    Box::new(Label::new(subtitle, 14.0, theme.text_muted)),
                                ])
        ...
        let header = Box::new(Flex::row(vec![
            Box::new(
                Flex::column(vec![
                    Box::new(Label::new("Lever UI Gallery", 42.0, theme.text)),
                    Box::new(Label::new(
                    ...
                    Box::new(AnimatedScale::new(
                        ...
                        Box::new(
                            BoxWidget::new(theme.primary.with_alpha(0.15))
                                ...
                                .with_child(Box::new(Label::new("Pulse", 16.0, theme.primary))),
                        ),
                    )),
                    Box::new(AnimatedTranslation::new(
                        ...
                        Box::new(
                            BoxWidget::new(theme.success.with_alpha(0.15))
                                ...
                                .with_size(140.0, 100.0)
                                .with_alignment(Alignment::Center)
                                .with_child(Box::new(Label::new("Float", 16.0, theme.success))),
                        ),
                    )),
                    Box::new(AnimatedOpacity::new(
                        ...
                        Box::new(
                            BoxWidget::new(theme.danger.with_alpha(0.15))
                                ...
                                .with_size(140.0, 100.0)
                                .with_alignment(Alignment::Center)
                                .with_child(Box::new(Label::new("Fade", 16.0, theme.danger))),
                        ),
                    )),
                    Box::new(
                        Flex::column(vec![
                            Box::new(
                                Flex::row(vec![
                                    Box::new(Label::new("Enable Pulse", 14.0, theme.text)),
                                    Box::new(
                            ...
                            Box::new(
                                Flex::row(vec![
                                    Box::new(Label::new("Enable Float", 14.0, theme.text)),
                                    Box::new(
                            ...
                            Box::new(
                                Flex::row(vec![
                                    Box::new(Label::new("Enable Fade", 14.0, theme.text)),
                                    Box::new(
            ...
            Box::new(Flex::column(vec![
                Box::new(
                    Flex::row(vec![
                        ...
                        Box::new(Button::new("btn-g", "Ghost").with_variant(ButtonVariant::Ghost)),
                    ])
                    .with_gap(12.0),
                ),
                ...
                section_card(
                    ...
                    Box::new(
                        BoxWidget::new(Color::TRANSPARENT)
                            ...
                            .with_child(Box::new(
                                Grid::new(
                                    vec![GridTrack::Flex(1), GridTrack::Flex(1)],
                                    vec![
                                        Box::new(
